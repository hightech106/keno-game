...
describe('FairnessService', () => {
  ...
  describe('hashServerSeed', () => {
    it('should return a SHA256 hash of the seed', () => {
      ...
      // echo -n "test-seed" | sha256sum
      // 3639efcd08abb276b418006db774628ee61843e01d06b63d86505a4178556214
      const expectedHash = '3639efcd08abb276b418006db774628ee61843e01d06b63d86505a4178556214';
